 ...
 * @internal
 */
export declare type UIHostConnection<T = unknown> = HostConnection<T> & UIHostMethods;
/** @public */
 ...
 * @internal
 */
export declare type GuestEmitter = GuestConnection & Emits<GuestConnectionEvents>;
/**
 * BEGIN EVENTS
 */
/**
