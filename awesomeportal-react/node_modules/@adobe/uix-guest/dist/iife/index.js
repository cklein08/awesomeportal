var AdobeUIXGuest = (() => {
  ...
  var require_dist = __commonJS({
    "../uix-core/dist/index.js"(exports) {
      ...
      var NS_ROOT = "_$pg";
      var VERSION = "0.8.4-nightly.20230922";
      ...
      function timeoutPromise2(describe, promise, ms, onReject) {
        return new Promise((resolve, reject) => {
...
Message must be an object with "${NS_ROOT}" property, which must be an object with a "version" string and an either an "accepts" or "offers" property containing an ID string.`
      ...
      var Tunnel = class extends import_eventemitter3.default {
        ...
        static _normalizeConfig(options = {}) {
          ...
          const config = {
            timeout: 4e3,
            ...options,
            logger: options.logger || quietConsole2
          };
      ...
      function formatHostMethodAddress2(address) {
        var _a, _b;
      ...
      exports.formatHostMethodAddress = formatHostMethodAddress2;
